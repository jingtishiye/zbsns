  ...
  var Buttons = /** @class */ (function () {
      ...
      Buttons.prototype.addToolbarButtons = function () {
          ...
          for (var styleIdx = 0, styleLen = this.options.styleTags.length; styleIdx < styleLen; styleIdx++) {
           ...
           var codetags = ['pre','blockquote'];
          this.context.memo('button.codetag', function () {
              ...
              return _this.ui.buttonGroup([
                  _this.button({
                      className: 'dropdown-toggle',
                      contents: _this.ui.dropdownButtonContents(_this.ui.icon('fa fa-hashtag'), _this.options),
                      tooltip: _this.lang.style.style,
                      data: {
                          toggle: 'dropdown'
                      }
          ...
          var _loop_2 = function (styleIdx, styleLen) {
              var item = codetags[styleIdx];

              this_2.context.memo('button.codetag.' + item, function () {
                  return _this.button({
                      className: 'note-btn-style-' + item,
                      contents: '<div data-value="' + item + '">' + item.toUpperCase() + '</div>',
                      tooltip: _this.lang.style[item],
          ...
          var this_2 = this;
         for (var styleIdx = 0, styleLen = codetags.length; styleIdx < styleLen; styleIdx++) {
              
              _loop_2(styleIdx, styleLen);
          }
